...
from versions_service.api.v1.health.endpoints import get_alive, get_ready, _postgres_ready
...
def test_get_alive(mocker):
    ...
    http_response = mocker.patch('versions_service.api.v1.health.endpoints.http_response')
...
def test_get_ready_success(mocker):
    ...
    _postgres_ready = mocker.patch('versions_service.api.v1.health.endpoints._postgres_ready')
...
def test__postgres_ready_success(mocker):
    ...
    db = mocker.patch('versions_service.api.v1.health.endpoints.db')
...
def test__postgres_ready_failure_exception(mocker):
    ...
    """
    expected_response = False
    app = mocker.patch('versions_service.api.v1.health.endpoints.app')
    db = mocker.patch('versions_service.api.v1.health.endpoints.db')
